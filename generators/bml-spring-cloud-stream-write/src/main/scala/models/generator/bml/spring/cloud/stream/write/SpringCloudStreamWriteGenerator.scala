package models.generator.bml.spring.cloud.stream.write
...
object SpringCloudStreamWrite extends SpringCloudStreamWriteGenerator {

}

class SpringCloudStreamWriteGenerator extends CodeGenerator {
